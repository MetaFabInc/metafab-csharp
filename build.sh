...
${nuget_cmd} install src/Org.MetaFab/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Org.MetaFab.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Org.MetaFab.dll \
-recurse:'src/Org.MetaFab/*.cs' \
-doc:bin/Org.MetaFab.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Org.MetaFab.dll was created successfully"
fi
