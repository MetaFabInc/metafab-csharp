...
namespace Org.MetaFab.Model
{
    ...
    public partial class AuthPlayer200Response :  IEquatable<AuthPlayer200Response>, IValidatableObject
    {
        ...
        public AuthPlayer200Response(string id = default(string), string gameId = default(string), string walletId = default(string), string connectedWalletId = default(string), string username = default(string), string accessToken = default(string), string updatedAt = default(string), string createdAt = default(string), WalletModel wallet = default(WalletModel))
        {
            this.Id = id;
            this.GameId = gameId;
