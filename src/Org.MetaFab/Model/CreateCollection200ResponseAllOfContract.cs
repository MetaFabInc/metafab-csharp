...
namespace Org.MetaFab.Model
{
    ...
    public partial class CreateCollection200ResponseAllOfContract :  IEquatable<CreateCollection200ResponseAllOfContract>, IValidatableObject
    {
        ...
        public CreateCollection200ResponseAllOfContract(string id = default(string), string gameId = default(string), string chain = default(string), Object abi = default(Object), string type = default(string), string address = default(string), string forwarderAddress = default(string), string updatedAt = default(string), string createdAt = default(string), List<TransactionModel> transactions = default(List<TransactionModel>))
        {
            this.Id = id;
            this.GameId = gameId;
            this.Chain = chain;
