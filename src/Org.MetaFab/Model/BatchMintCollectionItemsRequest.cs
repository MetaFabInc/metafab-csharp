...
namespace Org.MetaFab.Model
{
    ...
    public partial class BatchMintCollectionItemsRequest :  IEquatable<BatchMintCollectionItemsRequest>, IValidatableObject
    {
        ...
        public BatchMintCollectionItemsRequest(string address = default(string), List<decimal> itemIds = default(List<decimal>), List<decimal> quantities = default(List<decimal>), string walletId = default(string))
        {
