...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCurrency200ResponseAllOfContract :  IEquatable<CreateCurrency200ResponseAllOfContract>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCurrency200ResponseAllOfContract" /> class.
        /// </summary>
        ...
        public CreateCurrency200ResponseAllOfContract(string id = default(string), string gameId = default(string), string chain = default(string), Object abi = default(Object), string type = default(string), string address = default(string), string updatedAt = default(string), string createdAt = default(string), List<TransactionModel> transactions = default(List<TransactionModel>))
        {
            this.Id = id;
            this.GameId = gameId;
            this.Chain = chain;
        ...
        {
            return this.Equals(input as CreateCurrency200ResponseAllOfContract);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateCurrency200ResponseAllOfContract input)
        {
            if (input == null)
                return false;
