...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateLootboxManagerRequest :  IEquatable<CreateLootboxManagerRequest>, IValidatableObject
    {
        /// <summary>
        /// The blockchain you want to deploy this lootbox manager on. Support for new blockchains are added over time.
        /// </summary>
        /// <value>The blockchain you want to deploy this lootbox manager on. Support for new blockchains are added over time.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLootboxManagerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLootboxManagerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLootboxManagerRequest" /> class.
        /// </summary>
        /// <param name="name">The name of this item collection. This can be anything, such as &#x60;Production - Lootbox Manager&#x60;, &#x60;Testing - My Game Lootbox Manager&#x60;, etc..</param>
        /// <param name="chain">The blockchain you want to deploy this lootbox manager on. Support for new blockchains are added over time. (required).</param>
        public CreateLootboxManagerRequest(string name = default(string), ChainEnum chain = default(ChainEnum))
        {
            // to ensure "chain" is required (not null)
            if (chain == null)
            {
                throw new InvalidDataException("chain is a required property for CreateLootboxManagerRequest and cannot be null");
            }
            else
            {
                this.Chain = chain;
        ...
        /// </summary>
        /// <value>The name of this item collection. This can be anything, such as &#x60;Production - Lootbox Manager&#x60;, &#x60;Testing - My Game Lootbox Manager&#x60;, etc.</value>
        ...
        {
            return this.Equals(input as CreateLootboxManagerRequest);
        }

        /// <summary>
        /// Returns true if CreateLootboxManagerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateLootboxManagerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateLootboxManagerRequest input)
        {
            if (input == null)
                return false;
