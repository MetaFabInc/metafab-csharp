...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCurrency200Response :  IEquatable<CreateCurrency200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCurrency200Response" /> class.
        /// </summary>
        ...
        public CreateCurrency200Response(string id = default(string), string gameId = default(string), string contractId = default(string), string name = default(string), string symbol = default(string), int supplyCap = default(int), string updatedAt = default(string), string createdAt = default(string), CreateCurrency200ResponseAllOfContract contract = default(CreateCurrency200ResponseAllOfContract))
        {
            this.Id = id;
            this.GameId = gameId;
        ...
        {
            return this.Equals(input as CreateCurrency200Response);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateCurrency200Response input)
        {
            if (input == null)
                return false;
