...
namespace Org.MetaFab.Model
{
    ...
    public partial class ContractModel :  IEquatable<ContractModel>, IValidatableObject
    {
        ...
        /// <param name="forwarderAddress">This field has not had a description added..</param>
        ...
        public ContractModel(string id = default(string), string gameId = default(string), string chain = default(string), Object abi = default(Object), string type = default(string), string address = default(string), string forwarderAddress = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.GameId = gameId;
            this.Chain = chain;
