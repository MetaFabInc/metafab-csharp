...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShopModel :  IEquatable<ShopModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopModel" /> class.
        /// </summary>
        ...
        public ShopModel(string id = default(string), string gameId = default(string), string contractId = default(string), string name = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.GameId = gameId;
        ...
        {
            return this.Equals(input as ShopModel);
        }

        /// <summary>
        /// Returns true if ShopModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ShopModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShopModel input)
        {
            if (input == null)
                return false;
