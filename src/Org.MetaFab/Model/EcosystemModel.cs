...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EcosystemModel :  IEquatable<EcosystemModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EcosystemModel" /> class.
        /// </summary>
        ...
        public EcosystemModel(string id = default(string), string email = default(string), string name = default(string), string iconImageUrl = default(string), string coverImageUrl = default(string), string primaryColorHex = default(string), string publishedKey = default(string), string secretKey = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.Email = email;
            this.Name = name;
        ...
        {
            return this.Equals(input as EcosystemModel);
        }

        /// <summary>
        /// Returns true if EcosystemModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EcosystemModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EcosystemModel input)
        {
            if (input == null)
                return false;
