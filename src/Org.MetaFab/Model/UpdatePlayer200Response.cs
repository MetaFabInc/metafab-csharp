...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePlayer200Response :  IEquatable<UpdatePlayer200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePlayer200Response" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdatePlayer200Response);
        }

        /// <summary>
        /// Returns true if UpdatePlayer200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePlayer200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePlayer200Response input)
        {
            if (input == null)
                return false;
