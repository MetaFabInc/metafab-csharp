...
namespace Org.MetaFab.Model
{
    ...
    public partial class CreateCollectionRequest :  IEquatable<CreateCollectionRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateCollectionRequest" /> class.
        /// </summary>
        /// <param name="name">The name of this item collection. This can be anything, such as &#x60;Production - Item Collection&#x60;, &#x60;Testing - My Game Item Collection&#x60;, etc..</param>
        ...
        public CreateCollectionRequest(string name = default(string), ChainEnum chain = default(ChainEnum))
        {
            // to ensure "chain" is required (not null)
            if (chain == null)
            {
                throw new InvalidDataException("chain is a required property for CreateCollectionRequest and cannot be null");
            }
            else
            {
                this.Chain = chain;
        ...
        /// </summary>
        /// <value>The name of this item collection. This can be anything, such as &#x60;Production - Item Collection&#x60;, &#x60;Testing - My Game Item Collection&#x60;, etc.</value>
