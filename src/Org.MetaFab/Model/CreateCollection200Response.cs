...
namespace Org.MetaFab.Model
{
    ...
    public partial class CreateCollection200Response :  IEquatable<CreateCollection200Response>, IValidatableObject
    {
        ...
        public CreateCollection200Response(string id = default(string), string gameId = default(string), string contractId = default(string), string updatedAt = default(string), string createdAt = default(string), CreateCollection200ResponseAllOfContract contract = default(CreateCollection200ResponseAllOfContract))
        {
            this.Id = id;
            this.GameId = gameId;
