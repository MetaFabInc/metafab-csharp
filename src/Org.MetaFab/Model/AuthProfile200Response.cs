...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthProfile200Response :  IEquatable<AuthProfile200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthProfile200Response" /> class.
        /// </summary>
        ...
        public AuthProfile200Response(string id = default(string), string ecosystemId = default(string), string walletId = default(string), string connectedWalletId = default(string), string username = default(string), string accessToken = default(string), string updatedAt = default(string), string createdAt = default(string), string walletDecryptKey = default(string), WalletModel wallet = default(WalletModel), WalletModel custodialWallet = default(WalletModel))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as AuthProfile200Response);
        }

        /// <summary>
        /// Returns true if AuthProfile200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthProfile200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthProfile200Response input)
        {
            if (input == null)
                return false;
