...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetExchanges200ResponseInner :  IEquatable<GetExchanges200ResponseInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExchanges200ResponseInner" /> class.
        /// </summary>
        ...
        public GetExchanges200ResponseInner(string id = default(string), string gameId = default(string), string contractId = default(string), string updatedAt = default(string), string createdAt = default(string), ContractModel contract = default(ContractModel))
        {
            this.Id = id;
            this.GameId = gameId;
        ...
        {
            return this.Equals(input as GetExchanges200ResponseInner);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetExchanges200ResponseInner input)
        {
            if (input == null)
                return false;
