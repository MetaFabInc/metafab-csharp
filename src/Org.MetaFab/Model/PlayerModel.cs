...
namespace Org.MetaFab.Model
{
    ...
    public partial class PlayerModel :  IEquatable<PlayerModel>, IValidatableObject
    {
        ...
        public PlayerModel(string id = default(string), string gameId = default(string), string walletId = default(string), string connectedWalletId = default(string), string username = default(string), string accessToken = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.GameId = gameId;
