...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCollections200ResponseInner :  IEquatable<GetCollections200ResponseInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCollections200ResponseInner" /> class.
        /// </summary>
        ...
        public GetCollections200ResponseInner(string id = default(string), string gameId = default(string), string contractId = default(string), string updatedAt = default(string), string createdAt = default(string), CollectionModel contract = default(CollectionModel))
        {
            this.Id = id;
            this.GameId = gameId;
        ...
        public CollectionModel Contract { get; set; }
        ...
        {
            return this.Equals(input as GetCollections200ResponseInner);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetCollections200ResponseInner input)
        {
            if (input == null)
                return false;
