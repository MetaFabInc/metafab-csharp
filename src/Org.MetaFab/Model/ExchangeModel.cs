...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExchangeModel :  IEquatable<ExchangeModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeModel" /> class.
        /// </summary>
        ...
        public ExchangeModel(string id = default(string), string gameId = default(string), string contractId = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.GameId = gameId;
        ...
        {
            return this.Equals(input as ExchangeModel);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeModel input)
        {
            if (input == null)
                return false;
