...
namespace Org.MetaFab.Model
{
    ...
    public partial class BatchTransferCollectionItemsRequest :  IEquatable<BatchTransferCollectionItemsRequest>, IValidatableObject
    {
        ...
        public BatchTransferCollectionItemsRequest(List<string> addresses = default(List<string>), List<string> walletIds = default(List<string>), List<decimal> itemIds = default(List<decimal>), List<decimal> quantities = default(List<decimal>))
        {
