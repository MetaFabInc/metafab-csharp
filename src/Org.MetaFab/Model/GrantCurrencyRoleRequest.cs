...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantCurrencyRoleRequest :  IEquatable<GrantCurrencyRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantCurrencyRoleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GrantCurrencyRoleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantCurrencyRoleRequest" /> class.
        /// </summary>
        ...
        public GrantCurrencyRoleRequest(string role = default(string), string address = default(string), List<string> walletId = default(List<string>))
        {
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new InvalidDataException("role is a required property for GrantCurrencyRoleRequest and cannot be null");
            }
            else
            {
                this.Role = role;
        ...
        {
            return this.Equals(input as GrantCurrencyRoleRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GrantCurrencyRoleRequest input)
        {
            if (input == null)
                return false;
