...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExchangeOffer :  IEquatable<ExchangeOffer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeOffer" /> class.
        /// </summary>
        ...
        public ExchangeOffer(decimal id = default(decimal), string inputCollection = default(string), List<decimal> inputCollectionItemIds = default(List<decimal>), List<decimal> inputCollectionItemAmounts = default(List<decimal>), string inputCurrency = default(string), decimal inputCurrencyAmount = default(decimal), string outputCollection = default(string), List<decimal> outputCollectionItemIds = default(List<decimal>), List<decimal> outputCollectionItemAmounts = default(List<decimal>), string outputCurrency = default(string), decimal outputCurrencyAmount = default(decimal), decimal uses = default(decimal), decimal maxUses = default(decimal), decimal lastUpdatedAt = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ExchangeOffer);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeOffer input)
        {
            if (input == null)
                return false;
