...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PublicEcosystem :  IEquatable<PublicEcosystem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicEcosystem" /> class.
        /// </summary>
        ...
        public PublicEcosystem(string id = default(string), string name = default(string), string publishedKey = default(string), string iconImageUrl = default(string), string coverImageUrl = default(string), string primaryColorHex = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as PublicEcosystem);
        }

        /// <summary>
        /// Returns true if PublicEcosystem instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicEcosystem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicEcosystem input)
        {
            if (input == null)
                return false;
