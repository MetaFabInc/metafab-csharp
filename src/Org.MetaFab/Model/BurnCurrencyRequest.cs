...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BurnCurrencyRequest :  IEquatable<BurnCurrencyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnCurrencyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BurnCurrencyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnCurrencyRequest" /> class.
        /// </summary>
        ...
        public BurnCurrencyRequest(decimal amount = default(decimal))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BurnCurrencyRequest and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        {
            return this.Equals(input as BurnCurrencyRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BurnCurrencyRequest input)
        {
            if (input == null)
                return false;
