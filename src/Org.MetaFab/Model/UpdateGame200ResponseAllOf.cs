...
namespace Org.MetaFab.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateGame200ResponseAllOf :  IEquatable<UpdateGame200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateGame200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="walletDecryptKey">This field has not had a description added..</param>
        public UpdateGame200ResponseAllOf(string walletDecryptKey = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateGame200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if UpdateGame200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateGame200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateGame200ResponseAllOf input)
        {
            if (input == null)
                return false;
