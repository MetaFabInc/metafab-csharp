...
namespace Org.MetaFab.Model
{
    ...
    public partial class CollectionModel :  IEquatable<CollectionModel>, IValidatableObject
    {
        ...
        public CollectionModel(string id = default(string), string gameId = default(string), string contractId = default(string), string name = default(string), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.GameId = gameId;
