...
namespace Org.MetaFab.Model
{
    ...
    public partial class PublicPlayer :  IEquatable<PublicPlayer>, IValidatableObject
    {
        ...
        public PublicPlayer(string id = default(string), string gameId = default(string), string walletId = default(string), string connectedWalletId = default(string), string profileId = default(string), string username = default(string), string updatedAt = default(string), string createdAt = default(string), PublicPlayerCustodialWallet custodialWallet = default(PublicPlayerCustodialWallet), PublicPlayerCustodialWallet wallet = default(PublicPlayerCustodialWallet))
        {
            this.Id = id;
            this.GameId = gameId;
