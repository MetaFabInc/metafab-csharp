...
namespace Org.MetaFab.Api
{
    ...
    public interface IPlayersApi : IApiAccessor
    {
        ...
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="playerId">Any player id within the MetaFab platform.</param>
        /// <param name="playerWalletId">Any player wallet id within the MetaFab platform.</param>
        ...
        /// </remarks>
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="playerId">The player id of the authenticating player.</param>
        ...
        /// <param name="xAuthorization">The &#x60;accessToken&#x60; of the authenticating player.</param>
        /// <param name="updatePlayerRequest"></param>
        /// <returns>ApiResponse of UpdatePlayer200Response</returns>
        ApiResponse<UpdatePlayer200Response> UpdatePlayerWithHttpInfo (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest);
        ...
        /// <param name="updatePlayerRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdatePlayer200Response</returns>
        System.Threading.Tasks.Task<UpdatePlayer200Response> UpdatePlayerAsync (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="updatePlayerRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdatePlayer200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdatePlayer200Response>> UpdatePlayerWithHttpInfoAsync (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PlayersApi : IPlayersApi
    {
        ...
        /// <param name="updatePlayerRequest"></param>
        /// <returns>UpdatePlayer200Response</returns>
        public UpdatePlayer200Response UpdatePlayer (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest)
        {
             ApiResponse<UpdatePlayer200Response> localVarResponse = UpdatePlayerWithHttpInfo(playerId, xAuthorization, updatePlayerRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updatePlayerRequest"></param>
        /// <returns>ApiResponse of UpdatePlayer200Response</returns>
        public ApiResponse<UpdatePlayer200Response> UpdatePlayerWithHttpInfo (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest)
        {
            // verify the required parameter 'playerId' is set
            if (playerId == null)
            ...
            return new ApiResponse<UpdatePlayer200Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (UpdatePlayer200Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UpdatePlayer200Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdatePlayer200Response</returns>
        public async System.Threading.Tasks.Task<UpdatePlayer200Response> UpdatePlayerAsync (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UpdatePlayer200Response> localVarResponse = await UpdatePlayerWithHttpInfoAsync(playerId, xAuthorization, updatePlayerRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdatePlayer200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdatePlayer200Response>> UpdatePlayerWithHttpInfoAsync (string playerId, string xAuthorization, UpdatePlayerRequest updatePlayerRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'playerId' is set
            if (playerId == null)
                throw new ApiException(400, "Missing required parameter 'playerId' when calling PlayersApi->UpdatePlayer");
