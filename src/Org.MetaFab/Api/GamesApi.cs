...
namespace Org.MetaFab.Api
{
    ...
    public interface IGamesApi : IApiAccessor
    {
        ...
        ApiResponse<PublicGame> GetGameWithHttpInfo (string gameId);
        /// <summary>
        /// Update game
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gameId">The game id of the authenticating game.</param>
        ...
        /// <param name="xAuthorization">The &#x60;secretKey&#x60; of the authenticating game.</param>
        /// <param name="updateGameRequest"></param>
        /// <returns>ApiResponse of UpdateGame200Response</returns>
        ApiResponse<UpdateGame200Response> UpdateGameWithHttpInfo (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest);
        ...
        System.Threading.Tasks.Task<PublicGame> GetGameAsync (string gameId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicGame>> GetGameWithHttpInfoAsync (string gameId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update game
        /// </summary>
        /// <remarks>
        ...
        /// <param name="updateGameRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateGame200Response</returns>
        System.Threading.Tasks.Task<UpdateGame200Response> UpdateGameAsync (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="updateGameRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateGame200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdateGame200Response>> UpdateGameWithHttpInfoAsync (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class GamesApi : IGamesApi
    {
        ...
        public ApiResponse<AuthGame200Response> AuthGameWithHttpInfo ()
        {
            ...
            var localVarPath = "/v1/games/auth";
        ...
        /// <param name="gameId">Any game id within the MetaFab platform.</param>
        /// <returns>PublicGame</returns>
        public PublicGame GetGame (string gameId)
        {
             ApiResponse<PublicGame> localVarResponse = GetGameWithHttpInfo(gameId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="gameId">Any game id within the MetaFab platform.</param>
        /// <returns>ApiResponse of PublicGame</returns>
        public ApiResponse<PublicGame> GetGameWithHttpInfo (string gameId)
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
                throw new ApiException(400, "Missing required parameter 'gameId' when calling GamesApi->GetGame");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PublicGame</returns>
        public async System.Threading.Tasks.Task<PublicGame> GetGameAsync (string gameId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PublicGame> localVarResponse = await GetGameWithHttpInfoAsync(gameId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PublicGame)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PublicGame>> GetGameWithHttpInfoAsync (string gameId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
                throw new ApiException(400, "Missing required parameter 'gameId' when calling GamesApi->GetGame");
        ...
        /// <param name="updateGameRequest"></param>
        /// <returns>UpdateGame200Response</returns>
        public UpdateGame200Response UpdateGame (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest)
        {
             ApiResponse<UpdateGame200Response> localVarResponse = UpdateGameWithHttpInfo(gameId, xAuthorization, updateGameRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateGameRequest"></param>
        /// <returns>ApiResponse of UpdateGame200Response</returns>
        public ApiResponse<UpdateGame200Response> UpdateGameWithHttpInfo (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest)
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
            ...
            return new ApiResponse<UpdateGame200Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (UpdateGame200Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UpdateGame200Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateGame200Response</returns>
        public async System.Threading.Tasks.Task<UpdateGame200Response> UpdateGameAsync (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UpdateGame200Response> localVarResponse = await UpdateGameWithHttpInfoAsync(gameId, xAuthorization, updateGameRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateGame200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateGame200Response>> UpdateGameWithHttpInfoAsync (string gameId, string xAuthorization, UpdateGameRequest updateGameRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'gameId' is set
            if (gameId == null)
                throw new ApiException(400, "Missing required parameter 'gameId' when calling GamesApi->UpdateGame");
