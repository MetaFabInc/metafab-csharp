...
namespace Org.MetaFab.Api
{
    ...
    public interface ICurrenciesApi : IApiAccessor
    {
        ...
        decimal GetCurrencyBalances (string currencyId, string address = default(string), string walletId = default(string));
        ...
        ApiResponse<decimal> GetCurrencyBalancesWithHttpInfo (string currencyId, string address = default(string), string walletId = default(string));
        /// <summary>
        /// Get currency fees
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<decimal> GetCurrencyBalancesAsync (string currencyId, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<decimal>> GetCurrencyBalancesWithHttpInfoAsync (string currencyId, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get currency fees
        /// </summary>
        /// <remarks>
    ...
    public partial class CurrenciesApi : ICurrenciesApi
    {
        ...
        /// <param name="walletId">Any wallet id within the MetaFab ecosystem. (optional)</param>
        /// <returns>decimal</returns>
        public decimal GetCurrencyBalances (string currencyId, string address = default(string), string walletId = default(string))
        {
             ApiResponse<decimal> localVarResponse = GetCurrencyBalancesWithHttpInfo(currencyId, address, walletId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="walletId">Any wallet id within the MetaFab ecosystem. (optional)</param>
        /// <returns>ApiResponse of decimal</returns>
        public ApiResponse<decimal> GetCurrencyBalancesWithHttpInfo (string currencyId, string address = default(string), string walletId = default(string))
        {
            // verify the required parameter 'currencyId' is set
            if (currencyId == null)
                throw new ApiException(400, "Missing required parameter 'currencyId' when calling CurrenciesApi->GetCurrencyBalances");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetCurrencyBalances", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of decimal</returns>
        public async System.Threading.Tasks.Task<decimal> GetCurrencyBalancesAsync (string currencyId, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<decimal> localVarResponse = await GetCurrencyBalancesWithHttpInfoAsync(currencyId, address, walletId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (decimal)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<decimal>> GetCurrencyBalancesWithHttpInfoAsync (string currencyId, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'currencyId' is set
            if (currencyId == null)
                throw new ApiException(400, "Missing required parameter 'currencyId' when calling CurrenciesApi->GetCurrencyBalances");
