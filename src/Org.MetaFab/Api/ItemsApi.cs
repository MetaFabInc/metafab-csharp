...
namespace Org.MetaFab.Api
{
    ...
    public interface IItemsApi : IApiAccessor
    {
        ...
        decimal GetCollectionApproval (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string));
        ...
        ApiResponse<decimal> GetCollectionApprovalWithHttpInfo (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string));
        /// <summary>
        /// Get collection item
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<decimal> GetCollectionApprovalAsync (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<decimal>> GetCollectionApprovalWithHttpInfoAsync (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get collection item
        /// </summary>
        /// <remarks>
    ...
    public partial class ItemsApi : IItemsApi
    {
        ...
        /// <param name="walletId">Any wallet id within the MetaFab ecosystem. (optional)</param>
        /// <returns>decimal</returns>
        public decimal GetCollectionApproval (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string))
        {
             ApiResponse<decimal> localVarResponse = GetCollectionApprovalWithHttpInfo(collectionId, operatorAddress, address, walletId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="walletId">Any wallet id within the MetaFab ecosystem. (optional)</param>
        /// <returns>ApiResponse of decimal</returns>
        public ApiResponse<decimal> GetCollectionApprovalWithHttpInfo (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string))
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of decimal</returns>
        public async System.Threading.Tasks.Task<decimal> GetCollectionApprovalAsync (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<decimal> localVarResponse = await GetCollectionApprovalWithHttpInfoAsync(collectionId, operatorAddress, address, walletId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (decimal)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<decimal>> GetCollectionApprovalWithHttpInfoAsync (string collectionId, string operatorAddress, string address = default(string), string walletId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
                throw new ApiException(400, "Missing required parameter 'collectionId' when calling ItemsApi->GetCollectionApproval");
