...
namespace Org.MetaFab.Api
{
    ...
    public interface IWalletsApi : IApiAccessor
    {
        ...
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <param name="xWalletDecryptKey">The &#x60;walletDecryptKey&#x60; for the provided &#x60;walletId&#x60;.</param>
        /// <param name="createWalletSignatureRequest"></param>
        ...
        ApiResponse<string> CreateWalletSignatureWithHttpInfo (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest);
        /// <summary>
        /// Get wallet
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <returns>ApiResponse of WalletModel</returns>
        ApiResponse<WalletModel> GetWalletWithHttpInfo (string walletId);
        /// <summary>
        /// Get wallet balances
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<string> CreateWalletSignatureAsync (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> CreateWalletSignatureWithHttpInfoAsync (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get wallet
        /// </summary>
        /// <remarks>
        ...
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of WalletModel</returns>
        System.Threading.Tasks.Task<WalletModel> GetWalletAsync (string walletId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (WalletModel)</returns>
        System.Threading.Tasks.Task<ApiResponse<WalletModel>> GetWalletWithHttpInfoAsync (string walletId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get wallet balances
        /// </summary>
        /// <remarks>
    ...
    public partial class WalletsApi : IWalletsApi
    {
        ...
        /// <summary>
        /// Create wallet signature Creates a wallet signature from a plaintext message using the wallet for the provided walletId and walletDecryptKey. Wallet signatures cannot be generated for EOA wallets.
        /// </summary>
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <param name="xWalletDecryptKey">The &#x60;walletDecryptKey&#x60; for the provided &#x60;walletId&#x60;.</param>
        /// <param name="createWalletSignatureRequest"></param>
        /// <returns>string</returns>
        public string CreateWalletSignature (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest)
        {
             ApiResponse<string> localVarResponse = CreateWalletSignatureWithHttpInfo(walletId, xWalletDecryptKey, createWalletSignatureRequest);
        ...
        /// <param name="createWalletSignatureRequest"></param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse<string> CreateWalletSignatureWithHttpInfo (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest)
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling WalletsApi->CreateWalletSignature");
            // verify the required parameter 'xWalletDecryptKey' is set
            if (xWalletDecryptKey == null)
                throw new ApiException(400, "Missing required parameter 'xWalletDecryptKey' when calling WalletsApi->CreateWalletSignature");
            // verify the required parameter 'createWalletSignatureRequest' is set
            if (createWalletSignatureRequest == null)
                throw new ApiException(400, "Missing required parameter 'createWalletSignatureRequest' when calling WalletsApi->CreateWalletSignature");

            var localVarPath = "/v1/wallets/{walletId}/signatures";
            ...
            if (createWalletSignatureRequest != null && createWalletSignatureRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createWalletSignatureRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = createWalletSignatureRequest; // byte array
            }
            ...
            {
                Exception exception = ExceptionFactory("CreateWalletSignature", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> CreateWalletSignatureAsync (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<string> localVarResponse = await CreateWalletSignatureWithHttpInfoAsync(walletId, xWalletDecryptKey, createWalletSignatureRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> CreateWalletSignatureWithHttpInfoAsync (string walletId, string xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling WalletsApi->CreateWalletSignature");
        ...
        /// <summary>
        /// Get wallet Returns a wallet object for the provided walletId.
        /// </summary>
        /// <exception cref="Org.MetaFab.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <returns>WalletModel</returns>
        public WalletModel GetWallet (string walletId)
        {
             ApiResponse<WalletModel> localVarResponse = GetWalletWithHttpInfo(walletId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="walletId">Any wallet id within the MetaFab platform.</param>
        /// <returns>ApiResponse of WalletModel</returns>
        public ApiResponse<WalletModel> GetWalletWithHttpInfo (string walletId)
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling WalletsApi->GetWallet");

            var localVarPath = "/v1/wallets/{walletId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            return new ApiResponse<WalletModel>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (WalletModel) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(WalletModel)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of WalletModel</returns>
        public async System.Threading.Tasks.Task<WalletModel> GetWalletAsync (string walletId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<WalletModel> localVarResponse = await GetWalletWithHttpInfoAsync(walletId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (WalletModel)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<WalletModel>> GetWalletWithHttpInfoAsync (string walletId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling WalletsApi->GetWallet");
